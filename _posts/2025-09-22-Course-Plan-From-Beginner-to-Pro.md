...
|----------------|--------|----------------------------------|-------------------------------|
| Beginner      | 1. Cybersecurity Fundamentals | Basics, threat landscape, attack vectors, CIA triad, risk management, incident response. *Understand principles, identify threats, grasp threat hunting's role.* | Nmap, Wireshark, command-line tools; threat modeling, vulnerability scanning. *Books: "Hacking: The Art of Exploitation"; Online: Cybrary, TryHackMe; Courses: Coursera "Cybersecurity for Everyone".* (20-30 hours) |
| Beginner      | 2. Networking & OS Basics | TCP/IP, OSI model, protocols, Windows/Linux internals, file systems, permissions. *Learn where threats hide, understand data flow.* | ipconfig, netstat, ps, Event Viewer, syslog; packet analysis, log basics. *Books: "Computer Networking: A Top-Down Approach"; Online: Khan Academy; Labs: VirtualBox VMs.* (40-50 hours) |
| Beginner      | 3. Threat Hunting Intro | Definition, hunt types, Pyramid of Pain, IoCs vs. IoAs. *Define hunting, learn basic modeling.* | IOC Editor, Redline, PowerShell; hypothesis-based hunting, anomaly detection. *Courses: Security Blue Team, Coursera "Cyber Threat Hunting"; Resources: MITRE ATT&CK, Active Countermeasures.* (15-25 hours) |
| Beginner      | 4. Data Sources & Logs | System/network/application logs, Windows event logs, Linux syslog, SIEM basics. *Collect/parse logs, spot anomalies.* | Event Viewer, journalctl, grep, awk; log parsing, filtering. *Labs: Splunk Free, ELK Stack; Books: "Logging and Log Management".* (30-40 hours) |
| Beginner      | 5. Beginner Labs | Simple CTFs, malware intro, simulated threats. *Apply concepts in safe settings.* | VirtualBox, Metasploitable, Wireshark; packet capture. *Platforms: HackTheBox beginner, TryHackMe; YouTube: Threat Hunting Masterclass.* (20-30 hours) |
| Intermediate  | 6. Threat Intelligence | CTI, OSINT, STIX/TAXII, MITRE ATT&CK, APT/ransomware TTPs. *Apply intel, map TTPs.* | AlienVault OTX, VirusTotal, MISP; intelligence-driven hunting. *Courses: SANS FOR578, Udemy "Cyber Threat Intelligence"; Books: "Crafting the InfoSec Playbook".* (40-50 hours) |
| Intermediate  | 7. Hunting Methodologies | Hypothesis/data/hybrid hunts, structured vs. unstructured. *Execute hunts, use AI for anomalies.* | ML/UEBA, custom scripts; hunt plans, scoping. *Courses: Infosec "Threat Hunting Techniques", Exabeam; Resources: MITRE Engenuity.* (30-40 hours) |
| Intermediate  | 8. Endpoint Detection | EDR, endpoint forensics, process/registry analysis. *Detect persistence, credential theft.* | Sysinternals, Volatility, Carbon Black; log analysis, malware evasion hunting. *Courses: OffSec "Threat Hunting", Coursera host-based; LetsDefend.* (50-60 hours) |
| Intermediate  | 9. Network-Based Hunting | Traffic analysis, DNS/beaconing/C2 detection. *Spot network anomalies.* | Wireshark, Zeek, Suricata; PCAP, flow hunting. *Courses: Coursera network module, Cisco "Conducting Threat Hunting".* (40-50 hours) |
| Intermediate  | 10. SIEM & Log Analysis | SIEM deployment, SPL/KQL queries, correlation. *Large-scale analysis.* | Splunk, ELK, Microsoft Sentinel; query writing, dashboards. *Labs: Splunk BOTS; Courses: Practical Threat Hunting, TCM Security SOC 201.* (50-60 hours) |
| Intermediate  | 11. Intermediate Labs | APT/ransomware simulations. *Practice realistic hunts.* | Atomic Red Team, Caldera, HackTheBox; simulations, emulation. *Resources: Infosec simulators, CrowdStrike Falcon.* (30-40 hours) |
| Advanced/Pro | 12. Memory Forensics | Memory acquisition, malware/rootkit analysis. *Counter anti-forensics.* | Volatility, Rekall, WinDbg; Volatility plugins. *Courses: SANS FOR508 Section 3, Coursera advanced memory.* (50-60 hours) |
| Advanced/Pro | 13. Timeline & Artifact Analysis | Timeline creation, VSS/NTFS tactics. *Recover data, build timelines.* | Plaso, KAPE, Timeline Explorer; Plaso, Autopsy. *Courses: SANS FOR508 Sections 4-5, Mandiant "Practical Threat Hunting".* (40-50 hours) |
| Advanced/Pro | 14. Enterprise Hunting & IR | Lateral movement, PowerShell attacks, anti-forensics. *Scale hunts, track APTs.* | Splunk Enterprise, Elastic SIEM, Falcon; EDR at scale. *Courses: SANS FOR508, CrowdStrike FALCON 302; Black Hat USA 2025.* (60-70 hours) |
| Advanced/Pro | 15. Malware Analysis | Static/dynamic analysis, unpacking. *Derive IoCs/IoAs.* | IDA Pro, Ghidra, Cuckoo, REMnux; disassembly, debugging. *Books: "Practical Malware Analysis"; Courses: SANS FOR610.* (50-60 hours) |
| Advanced/Pro | 16. Threat Actor Analysis | APT TTPs, ransomware strategies. *Develop bespoke hunts.* | MITRE ATT&CK, Mandiant/Kaspersky reports; TTP mapping. *Courses: OffSec advanced, Google Cloud "Practical Threat Hunting".* (40-50 hours) |
| Advanced/Pro | 17. Automation & Tooling | Scripting, ML anomaly detection, playbooks. *Automate tasks.* | Python (Scapy, Pandas), Scikit-learn; Python scripting. *Resources: Cyborg Security webinars, Reddit r/cybersecurity.* (30-40 hours) |
| Advanced/Pro | 18. Certifications & Development | Cert prep, career paths, metrics. *Achieve credentials, measure success.* | GIAC GCFA, CCTH, OSTH, MTH, MAD20, Google PSOE; exam simulations. *Resources: GIAC, OffSec, Mosse.* (20-30 hours) |
| Advanced/Pro | 19. Capstone Projects | Enterprise simulations, red/blue exercises. *Integrate skills, report findings.* | Custom labs, DEF CON CTFs; end-to-end hunts. *Resources: SANS FOR508 Challenge, CrowdStrike labs.* (50-60 hours) |
| Advanced/Pro | 20. Continuous Learning | Emerging threats, conferences. *Stay updated, contribute.* | Arxiv, Black Hat/RSA, @SwiftOnSecurity, SOC Prime; research, feeds. *Ongoing (10-20 hours/month).* |
